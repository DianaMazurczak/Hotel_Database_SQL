...
/****** Object:  Trigger [dbo].[GuestsDeleteTrigger]    Script Date: 17.03.2024 10:45:30 ******/
SET ANSI_NULLS ON
GO
...
CREATE TRIGGER [dbo].[GuestsDeleteTrigger]
ON [dbo].[Guests]
AFTER DELETE
AS
...
ALTER TABLE [dbo].[Guests] ENABLE TRIGGER [GuestsDeleteTrigger]
GO
